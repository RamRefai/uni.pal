...
function CampusSelection() {
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      <select 
        className="block appearance-none w-20% bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline dark:text-black"
